...
class DatabaseService {
  ...
  static void followUser({String currentUserId, String userId}) {
    // Add userId to current user's following collection
    followingRef
    ...
    // Add current user to userId's followers collection
    followersRef
        .document(userId)
  ...
  static void unFollowUser({String currentUserId, String userId}) {
    ...
    // Remove current user to userId's followers collection
    followersRef
        .document(userId)
        .collection('userFollowers')
        .document(currentUserId)
